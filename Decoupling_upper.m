...
%% User Settings
% Choose Shot
shot = "49298";settings.valveplenumpressure=500;
...
delete(f2.Children(4).Children)
f2.Children(4).Title.String='Upper divertor valve perturbation';
...
f2.Children(4).YAxis(1).Limits=[7.3   9.4];
...
f2.Children(4).YAxis(1).Label.String='$\mathrm{Upper \ D}_{\mathrm{alpha}} \ [\mathrm{V}]$';
f2.Children(2).YAxis(1).Label.String='$|\delta\mathrm{Upper \ D}_{\mathrm{alpha}}(\mathrm{f})| \ [\mathrm{V}]$';
...
f2.Children(2).Position=[0.145    0.1428    0.72   0.3412];
f2.Children(4).Position=[0.145    0.5938    0.72   0.3412];
f2.Children(4).YAxis(1).Limits=[0.425   0.485];
f2.Children(2).XLabel.Units='normalized';
...
%note
annotation('textarrow',[0.335384615384616,0.409230769230769],[0.451162790697674,0.423953488372093],'String','No response','FontSize',14)