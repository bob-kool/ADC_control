...
%% Override legend
f2.Children(2).YLabel.String='$|\delta \mathrm{Midplane\ D}_{\mathrm{alpha}}(\mathrm{f})|\ [\mathrm{V}]$';
f2.Children(4).YAxis(2).Label.String='$\mathrm{Midplane\ D}_{\mathrm{alpha}}\ [\mathrm{V}]$';
